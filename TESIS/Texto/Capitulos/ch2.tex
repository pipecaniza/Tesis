...
\begin{exmp}
	...
	Con éste nuevo parser se puede enviar una función que retorna un \emph{bool} permitiendo crear parsers en los que la evaluación se realice con una función personalizada.
